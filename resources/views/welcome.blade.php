...
<body>
    ...
    <nav class="navbar px-md-0 navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
        <div class="container">
        <a class="navbar-brand" href="index.html">Dahab<i>iBlog</i>.</a>
    ...
    <div class="container">
        ...
        <div class="col-md-12 ftco-animate">
            ...
            <h1 class="mb-4 mb-md-0">Dahab iblog</h1>
            <div class="row">
                <div class="col-md-7">
                    <div class="text">
            ...
            <div class="case">
                ...
                <div class="col-md-6 col-lg-6 col-xl-4 d-flex">
                    ...
                    <ul class="media-social list-unstyled">
                        ...
                        <li class="ftco-animate"><a href="https://www.facebook.com/muhammad.gamalzayan/"><span class="icon-facebook"></span></a></li>
                        <li class="ftco-animate"><a href="https://www.instagram.com/mohamedgamalzayan/"><span class="icon-instagram"></span></a></li>
                    </ul>
                    <div class="meta">
                    <p class="mb-0">
    ...
    <div class="container">
        ...
        <div class="col-md">
            ...
            <h2 class="logo"><a href="#">Dahab<span>iBlog</span>.</a></h2>
        ...
        <div class="col-md">
            <div class="ftco-footer-widget mb-4">
                ...
                <ul>
                    <li><span class="icon icon-map-marker"></span><span class="text">Egypt , Qina </span></li>
                    <li><a href="#"><span class="icon icon-phone"></span><span class="text">+201030303532</span></a></li>
                    <li><a href="mailto:muhammadgamalzayan@gmail.com"><span class="icon icon-envelope"></span><span class="text">Mail Me Now</span></a></li>
                    <li><a href="https://wa.me/01030303532"><span class="icon icon-whatsapp"></span><span class="text">Whatsapp Me</span></a></li>
...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved 2021 | This template is made with <i class="icon-heart color-danger" aria-hidden="true"></i> by <a href="https://colorlib.com" target="_blank">Dahab</a>
